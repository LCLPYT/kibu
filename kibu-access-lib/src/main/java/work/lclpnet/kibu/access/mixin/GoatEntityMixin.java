...
@Mixin(Goat.class)
public abstract class GoatEntityMixin extends Animal implements KibuGoatEntity {
    ...
    protected GoatEntityMixin(EntityType<? extends Animal> entityType, Level world) {
